...
namespace detai_HoangQuan
{
    public partial class frmHome : Form
    {
        ...
        {
            MessageBox.Show("Tên sinh viên: Trần Mạnh Tùng - 19DH110861 \n                        Phùng Trọng Khang - 19DH110450 \nLớp:  PM1904");
        }
        #endregion

        private void hướngDẫnSửDụngToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Không thể phát nhạc \nKhông có video và hình ảnh \nKhông có cộng đồng và góp ý");
        }

        private void lvwBaiHat_Home_SelectedIndexChanged(object sender, EventArgs e)
        {
